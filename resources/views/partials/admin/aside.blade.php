    ...
    <div class="u-sidebar-inner">
        ...
        <nav class="u-sidebar-nav">
            <ul class="u-sidebar-nav-menu u-sidebar-nav-menu--top-level">
                ...
                <li class="u-sidebar-nav-menu__item">
                    <a class="u-sidebar-nav-menu__link {{ return_if(on_page('admin.stores.index') OR on_page('admin.stores.create') OR on_page('admin.stores.edit'), ' active') }}" href="{{ route('admin.stores.index') }}">
                        <i class="fas fa-shopping-bag u-sidebar-nav-menu__item-icon"></i>
                        <span class="u-sidebar-nav-menu__item-title">{{ __('Stores') }}</span>
                    </a>
                </li>


                <li class="u-sidebar-nav-menu__item">
                    <a class="u-sidebar-nav-menu__link {{ return_if(on_page('admin.product.index') OR on_page('admin.product.create') OR on_page('admin.product.edit'), ' active') }}" href="{{ route('admin.product.index') }}">
                        <i class="fas fa-database u-sidebar-nav-menu__item-icon"></i>
                        <span class="u-sidebar-nav-menu__item-title">{{ __('Products') }}</span>
                    </a>
                </li>


                <li class="u-sidebar-nav-menu__item">
                    <a class="u-sidebar-nav-menu__link {{ return_if(on_page('admin.dns.index') OR on_page('admin.dns.create') OR on_page('admin.dns.edit'), ' active') }}" href="{{ route('admin.dns.index') }}">
