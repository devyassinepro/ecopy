...
<meta charset="utf-8">
    ...
    <title>{{ config('app.name') }} - Copier des produits vers Shopify | Importateur de produits</title>
            ...
            <nav class="navbar navbar-expand-xl navbar-dark z-10">
                ...
                @endif
                    ...
                    <div class="collapse navbar-collapse justify-content-center">
                        ...
                        @if(Request::is('/') || Request::is('fr'))
                            <li><a href="/" class="nav-link">{{ __('Accueil') }}</a></li>
                            <li><a href="#faq" class="nav-link">{{ __('FAQ') }}</a></li>
                            <li><a href="#pricing" class="nav-link">{{ __('Tarification') }}</a></li>
                ...
                <div class="offcanvas-body z-10">
                    ...
                    <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                        <li class="nav-item dropdown">
                            ...
                            <li><a href="/dashboard" class="nav-link">{{ __('Tableau de bord') }}</a></li>
                            <li><a href="{{ route('account.password') }}" class="nav-link">{{ __('Mot de passe') }}</a></li>
                            <li>  
                                <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();">
                            <span class="dropdown-item-icon">
