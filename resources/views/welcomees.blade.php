...
<meta charset="utf-8">
    ...
    <title>{{ config('app.name') }} - Copiar productos a Shopify | Importador de productos</title>
        ...
        <nav class="navbar navbar-expand-xl navbar-dark z-10">
            ...
            @endif
                ...
                <div class="collapse navbar-collapse justify-content-center">
                    ...
                    @if(Request::is('/') || Request::is('es'))
                        <li><a href="/" class="nav-link">{{ __('Inicio') }}</a></li>
                        <li><a href="#faq" class="nav-link">{{ __('FAQ') }}</a></li>
                        <li><a href="#pricing" class="nav-link">{{ __('Precios') }}</a></li>
                        <li><a href="/contact" class="nav-link">{{ __('Contacto') }}</a></li>
                    @endif
            </ul>
            </div>
            @guest
            ...
            <div class="offcanvas-body z-10">
                ...
                <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                    <li class="nav-item dropdown">
                        ...
                        <li><a href="/dashboard" class="nav-link">{{ __('Tablero') }}</a></li>
                        <li><a href="{{ route('account.password') }}" class="nav-link">{{ __('Contraseña') }}</a></li>
                        <li>  
                            <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                    document.getElementById('logout-form').submit();">
                        <span class="dropdown-item-icon">
                ...
                <div class="col-lg-7 col-md-8">
                    <div class="subscribe-info-wrap text-center position-relative z-2">
                        ...
                        <ul class="nav justify-content-center subscribe-feature-list mt-4">
                            <li class="nav-item">
                                <span><i class="far fa-check-circle text-primary me-2"></i>Prueba gratuita de 2 días</span>
                            </li>
                            <li class="nav-item">
