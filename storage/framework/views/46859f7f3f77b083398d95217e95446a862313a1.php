...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.utils.link','data' => ['href' => $href,'class' => 'btn btn-info btn-sm','icon' => 'fas fa-search','text' => __('View'),'permission' => ''.e($permission).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH /Users/touzani/Desktop/ecopy/resources/views/components/utils/view-button.blade.php ENDPATH**/ ?>