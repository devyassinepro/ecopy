...
<div class="u-body">
    <div class="w-100 flex-container">
        <h1 class="mb-4 h2 font-weight-semibold"> <i class="fa fa-align-justify"></i> <?php echo e(__('Subscriptions cancel')); ?></h1>
    </div>
    <div class="mb-4 card">
            <div class="card-body">
                <table class="table table-responsive-sm table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($subscription->reason); ?></td>
                            <td><?php echo e($subscription->team->name); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/touzani/Desktop/ecopy/resources/views/admin/subscriptions/cancel.blade.php ENDPATH**/ ?>