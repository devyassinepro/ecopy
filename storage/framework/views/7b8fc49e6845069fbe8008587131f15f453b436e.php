...
<meta charset="utf-8">
    ...
    <title><?php echo e(config('app.name')); ?> - Copiar produtos para Shopify | Importador de produtos</title>
    ...
    <div class="main-wrapper">
        ...
        <header class="main-header position-absolute w-100">
            <nav class="navbar navbar-expand-xl navbar-dark z-10">
                ...
                <?php if(Request::is('/') || Request::is('pt')): ?>
                ...
                <?php endif; ?>
                    ...
                    <div class="collapse navbar-collapse justify-content-center">
                        ...
                        <?php if(Request::is('/') || Request::is('pt')): ?>
                            <li><a href="/" class="nav-link"><?php echo e(__('Início')); ?></a></li>
                            <li><a href="#faq" class="nav-link"><?php echo e(__('FAQ')); ?></a></li>
                            <li><a href="#pricing" class="nav-link"><?php echo e(__('Preços')); ?></a></li>
                            <li><a href="/contact" class="nav-link"><?php echo e(__('Contato')); ?></a></li>
                        <?php endif; ?>
                </ul>
                </div>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                     <span class="avatar rounded-circle">
                                        <img alt="Imagem de perfil" class="rounded-circle" width="35" src="<?php echo e(Auth::user()->profile_photo_url); ?>">
                                    </span>
                                </a>
                                    ...
                                    <div class="dropdown-grid rounded-custom">
                                        ...
                                        <a class="dropdown-item" href="/dashboard">
                                                ...
                                                <a class="dropdown-item" target="__blank" href="<?php echo e(route('admin.index')); ?>">
                                                    ...
                                                    <?php echo e(__('Painel de Administração')); ?>
                ...
                <div class="offcanvas-body z-10">
                    ...
                    <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                        <li class="nav-item dropdown">
                            ...
                            <li><a href="/dashboard" class="nav-link"><?php echo e(__('Painel de Controle')); ?></a></li>
                            <li><a href="<?php echo e(route('account.password')); ?>" class="nav-link"><?php echo e(__('Senha')); ?></a></li>
                            <li>  
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();">
                            <span class="dropdown-item-icon">
...
$__html = app('livewire')->mount($__name, $__params, 'ok2vGUr', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /Users/touzani/Desktop/ecopy/resources/views/welcomept.blade.php ENDPATH**/ ?>