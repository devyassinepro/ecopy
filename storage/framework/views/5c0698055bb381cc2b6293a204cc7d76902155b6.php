...
<meta charset="utf-8">
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo e(asset('assets/img/favicon.png')); ?>" title="Favicon" sizes="16x16" />
    <!-- bootstrap 5 -->
...
<body>
            ...
            <nav class="navbar navbar-expand-xl navbar-dark z-10">
                <div class="container d-flex align-items-center justify-content-lg-between position-relative">
                    <a href="/" class="navbar-brand d-flex align-items-center mb-md-0 text-decoration-none">
                        <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="logo" class="img-fluid logo-white" />
                        <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="logo" class="img-fluid logo-color" />
                    </a>
    ...
    <script src="<?php echo e(asset('assets/js/vendors/parallax.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/vendors/jquery.magnific-popup.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/vendors/aos.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/vendors/massonry.min.js')); ?>"></script>
    <script src="https://codepen.io/steveg3003/pen/zBVakw.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/1.18.4/TweenMax.min.js"></script>

</body>
</html>
<?php /**PATH /Users/touzani/Desktop/ecopy/resources/views/layouts/blog.blade.php ENDPATH**/ ?>