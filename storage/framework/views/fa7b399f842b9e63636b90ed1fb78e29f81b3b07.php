...
<meta charset="utf-8">
    ...
    <title><?php echo e(config('app.name')); ?> - Producten kopiëren naar Shopify | Product Importeur</title>
    ...
    <div class="main-wrapper">
        ...
        <header class="main-header position-absolute w-100">
            <nav class="navbar navbar-expand-xl navbar-dark z-10">
                ...
                <?php if(Request::is('/') || Request::is('nl')): ?>
                ...
                <?php endif; ?>
                    ...
                    <div class="collapse navbar-collapse justify-content-center">
                        ...
                        <?php if(Request::is('/') || Request::is('nl')): ?>
                            ...
                            <li><a href="#pricing" class="nav-link"><?php echo e(__('Prijzen')); ?></a></li>
                ...
                <div class="offcanvas-body z-10">
                    ...
                    <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                        <li class="nav-item dropdown">
                            ...
                            <li><a href="<?php echo e(route('account.password')); ?>" class="nav-link"><?php echo e(__('Wachtwoord')); ?></a></li>
                            <li>  
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();">
                            <span class="dropdown-item-icon">
...
$__html = app('livewire')->mount($__name, $__params, '1VGhKUs', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /Users/touzani/Desktop/ecopy/resources/views/welcomenl.blade.php ENDPATH**/ ?>